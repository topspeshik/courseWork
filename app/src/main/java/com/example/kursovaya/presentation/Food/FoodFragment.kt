...
class FoodFragment : Fragment() {
    ...
    private fun setupFood(mealsTime: String, listIt:  List<MealsWithFoodTuple>){
        var protein = 0
        var carb = 0
        var fats = 0
        listIt.forEach {
